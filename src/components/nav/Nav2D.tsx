        ...
        {tier !== 'flat' && (
          <span ref={blotRef} className={styles.logoBlot} aria-hidden="true">
            <InkSplat
              ...
              ink={page[scheme].ink}
              nacre={0.85}
              // A round mass around the mark rather than a star: most of the
              // ink stays in the blot, and what does fly is short. It is drawn
              // a little larger to make up for it, so the blot still carries
              // past the bar's edge above and below, which is the whole point
              // of it being behind the bar.
              scale={1.35}
              spatter={0.4}
            />
          </span>
