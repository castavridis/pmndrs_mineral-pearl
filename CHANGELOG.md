...
| The somewhat-expressive tier drifts, dampened | Half the announcement's amplitude over a longer period, each item on its own delay. They are controls: a control that wanders is harder to hit. |
